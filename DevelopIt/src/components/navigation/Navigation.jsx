...
export default function Navigation(){
    return(
      <>
        ...
        <nav className="margin border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 fix-color">
    <a href="#" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img
        ...
        alt="Flowbite Logo"
      />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white white-color">
        DevelopIt
      </span>
    </a>
    <button
